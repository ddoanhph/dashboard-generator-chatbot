...
```
SCHEMA = {
    "Nominative_List_Unique_ID": T.StringType(),
    "Corporate_ID": T.StringType(),
    "First_Name": T.StringType(),
    "Last_Name": T.StringType(),
    "Gender": T.StringType(),
    "Age": T.StringType(),
    "Age_Group": T.StringType(),
    "Position_ID": T.StringType(),
    "Position_Title": T.StringType(),
    "Primary_Job": T.BooleanType(),
    "Job_Profile_ID": T.StringType(),
    "Job_Profile": T.StringType(),
    "Job_Family": T.StringType(),
    "Job_Family_Group": T.StringType(),
    "Job_Category": T.StringType(),
    "Function": T.StringType(),
    "Band": T.StringType(),
    "Blue_White_Collar": T.StringType(),
    "Worker_Category": T.StringType(),
    "Position_Worker_Type": T.StringType(),
    "Professional_Category": T.StringType(),
    "Contract_Type": T.StringType(),
    "FTE": T.StringType(),
    "Active_Workforce_Status": T.StringType(),
    "Current_Staffing_Status": T.StringType(),
    "Company_Code": T.StringType(),
    "Company_Name": T.StringType(),
    "Entity_Code": T.StringType(),
    "Entity_Name": T.StringType(),
    "Consolidation_Key": T.StringType(),
    "Business_Scope": T.StringType(),
    "OP_Driver_AI_Commercial": T.StringType(),
    "Financial_Division_ID": T.StringType(),
    "Financial_Division_Code": T.StringType(),
    "Financial_Division_Name": T.StringType(),
    "Core_Division": T.StringType(),
    "Location_ID": T.StringType(),
    "Location_Name": T.StringType(),
    "Establishment_ID": T.StringType(),
    "Establishment_Name": T.StringType(),
    "City_Name": T.StringType(),
    "Company_Country": T.StringType(),
    "Company_Country_ISO2": T.StringType(),
    "Company_Country_ISO3": T.StringType(),
    "Reporting_Region": T.StringType(),
    "Snapshot_Month": T.StringType(),
    "Snapshot_Year": T.StringType(),
    "Supervisory_Organization_Siglum": T.StringType(),
    "Supervisory_Organization_Name": T.StringType(),
    "Band_Level": T.StringType(),
    "Compensation_Grade_Profile": T.StringType(),
    "Cost_Center": T.StringType(),
    "Cost_Center_Code": T.StringType(),
    "Cost_Center_Short_Code": T.StringType(),
    "Cost_Center_Name": T.StringType(),
    "Cost_Center_Controlling_Area": T.StringType(),
    "Is_HRBP": T.StringType(),
    "Is_Operating_Manager": T.StringType(),
    "Country": T.StringType(),
    "Work_Email": T.StringType(),
    "Operational_Manager_Corporate_ID": T.StringType(),
    "HRBP_Corporate_ID": T.StringType(),
    "Original_Hire_Date": T.StringType(),
    "Seniority_Date": T.StringType(),
    "Continuous_Service_Date": T.StringType(),
    "Direct_Indirect": T.StringType(),
    "Legacy_SAP_ID": T.StringType(),
    "Time_In_Job_Profile_Start_Date": T.StringType(),
    "Supervisory_Organization_Level_1_ID": T.StringType(),
    "Supervisory_Organization_Level_1_Siglum": T.StringType(),
    "Supervisory_Organization_Level_1_Name": T.StringType(),
    "Supervisory_Organization_Level_2_ID": T.StringType(),
    "Supervisory_Organization_Level_2_Siglum": T.StringType(),
    "Supervisory_Organization_Level_2_Name": T.StringType(),
    "Supervisory_Organization_Level_3_ID": T.StringType(),
    "Supervisory_Organization_Level_3_Siglum": T.StringType(),
    "Supervisory_Organization_Level_3_Name": T.StringType(),
    "Supervisory_Organization_Level_4_ID": T.StringType(),
    "Supervisory_Organization_Level_4_Siglum": T.StringType(),
    "Supervisory_Organization_Level_4_Name": T.StringType(),
    "Supervisory_Organization_Level_5_ID": T.StringType(),
    "Supervisory_Organization_Level_5_Siglum": T.StringType(),
    "Supervisory_Organization_Level_5_Name": T.StringType(),
    "Supervisory_Organization_Level_6_ID": T.StringType(),
    "Supervisory_Organization_Level_6_Siglum": T.StringType(),
    "Supervisory_Organization_Level_6_Name": T.StringType(),
    "Supervisory_Organization_Level_7_ID": T.StringType(),
    "Supervisory_Organization_Level_7_Siglum": T.StringType(),
    "Supervisory_Organization_Level_7_Name": T.StringType(),
    "Supervisory_Organization_Level_8_ID": T.StringType(),
    "Supervisory_Organization_Level_8_Siglum": T.StringType(),
    "Supervisory_Organization_Level_8_Name": T.StringType(),
    "Supervisory_Organization_Level_9_ID": T.StringType(),
    "Supervisory_Organization_Level_9_Siglum": T.StringType(),
    "Supervisory_Organization_Level_9_Name": T.StringType(),
    "Supervisory_Organization_Level_10_ID": T.StringType(),
    "Supervisory_Organization_Level_10_Siglum": T.StringType(),
    "Supervisory_Organization_Level_10_Name": T.StringType(),
    "Supervisory_Organization_Level_11_ID": T.StringType(),
    "Supervisory_Organization_Level_11_Siglum": T.StringType(),
    "Supervisory_Organization_Level_11_Name": T.StringType(),
    "Is_Latest_Snapshot": T.BooleanType(),
    "Snapshot_Month_Series": T.TimestampType()
}
---
